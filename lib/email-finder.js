    ...
    return new Promise(function (resolve, reject) {
        ...
        emailExistence.check("catchalltest123@" + domain, function (err, res) {
            ...
            if (!res) {
                ...
                checker_object = {status: 'catch-all',first_name: firstname, middle_name: middlename, last_name: lastname, email: emailsArr.slice(0,5)};
                return resolve(checker_object);
            }
        });
        ...
        q.drain = function () {
            ...
            // reject();
            checker_object = {status: 'not-found',first_name: firstname, middle_name: middlename, last_name: lastname, email: emailsArr.slice(0,5)};
            return resolve(checker_object)
        }
    });
}
